...
@gin.configurable
class JaxxQuantileAgent(dqn_agent.JaxDQNAgent):
  ...
  def __init__(self,
    ...
    super(JaxxQuantileAgent, self).__init__(
        num_actions=num_actions,
        observation_shape=observation_shape,
        observation_dtype=observation_dtype,
        stack_size=stack_size,
        network=network.partial(num_atoms=num_atoms, minatar=self._minatar,
                                env=self._env,
